...
# --- Colores de la marca Kreadores (extraídos del sitio web) ---
PRIMARY_COLOR = "#667eea"  # Azul principal
SECONDARY_COLOR = "#764ba2"  # Púrpura secundario
ACCENT_COLOR = "#f093fb"  # Rosa acento
BACKGROUND_COLOR = "#f8f9fa"  # Fondo claro
TEXT_COLOR = "#2d3748"  # Texto oscuro
SUCCESS_COLOR = "#48bb78"  # Verde éxito
WARNING_COLOR = "#ed8936"  # Naranja advertencia
DANGER_COLOR = "#f56565"  # Rojo peligro
...
if os.path.exists(logo_path_sidebar):
    ...
    <div style="text-align: center; padding: 10px;">
        ...
        <div style="font-size: 1.2rem; font-weight: bold; color: #667eea;">KREADORES</div>
        <div style="font-size: 0.8rem; color: #6c757d;">Analytics Dashboard</div>
    </div>
    '''
